...
# Bot information
API_ID = environ.get('API_ID', '22119300')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '7008a6b3605a7ca6a923a6622b5f1832') #api hash of your telegram id
if len(API_HASH) == 0:
    print('Error - API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6753013266:AAFTPXSXvjHJyY4BkiCUyWjZUj7KRhWPrCM') #bot token from botfather
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '1270325350') #apni tg id daalo
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001665111212').split()]
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002037593743') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001713833919') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Kunjumon:OIzyqnEsnodg3PDs@kunjupanic.dnd9mag.mongodb.net/?retryWrites=true&w=majority") #mongo db url
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001990075313") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://github.com/Rishikesh-Sharma09/Auto-filter-bot") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
